...
GPU_TEMPLATE = r"GPU TEMP: {{ '%s' % gpu_temp }}°C"
"""Default GPU temp status template."""
...
class Config(BaseModel):
    ...
    server_status_template: str = "\n".join(
        (CPU_TEMPLATE, GPU_TEMPLATE, MEMORY_TEMPLATE, RUNTIME_TEMPLATE, SWAP_TEMPLATE, DISK_TEMPLATE)
    )
